...
class Estudiantes(models.Model):
    ...
    id_programa = models.IntegerField(db_column='id_Programa')  # Field name made lowercase.
    ...
    contrasena = models.CharField(db_column='Contrase�a', max_length=45)  # Field name made lowercase.
...
class Ingreso(models.Model):
    ...
    hora_ingreso = models.TimeField(db_column='Hora_Ingreso')  # Field name made lowercase.
